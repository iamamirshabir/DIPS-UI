...
export class PhysicianDialogComponent implements OnInit {
  ...
  myDateFilter = (d: Date | null): boolean => {
    ...
    return day !== this.invalidDays[0] && day !== this.invalidDays[1] && day !== this.invalidDays[2] && day !== this.invalidDays[3] && day !== this.invalidDays[4] && day !== this.invalidDays[5] && day !== 0;
  }
  onNoClick(): void {
